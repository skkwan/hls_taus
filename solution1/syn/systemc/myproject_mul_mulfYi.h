...
#ifndef __myproject_mul_mulfYi__HH__
#define __myproject_mul_mulfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_mul_mulfYi) {
    ...
    SC_CTOR(myproject_mul_mulfYi):  ACMP_mul_su_U ("ACMP_mul_su_U") {
